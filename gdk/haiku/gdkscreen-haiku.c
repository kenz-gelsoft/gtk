 ...
 * function gdk_haiku_screen_calculate_layout().
 *
...
static void  gdk_haiku_screen_calculate_layout (GdkHaikuScreen  *screen,
                                                 GdkHaikuDisplay *display);
static void  gdk_haiku_screen_reconfigure      (GdkHaikuDisplay *display,
...
void
_gdk_haiku_screen_update_window_sizes (GdkScreen *screen)
{
  GList *windows, *list;
...
static void
gdk_haiku_screen_reconfigure (GdkHaikuDisplay *display, GdkHaikuScreen *screen)
{
  int width, height;
  ...
  gdk_haiku_screen_calculate_layout (screen, display);

  _gdk_haiku_screen_update_window_sizes (GDK_SCREEN (screen));
...
gdk_haiku_screen_class_init (GdkHaikuScreenClass *klass)
{
  ...
  screen_class->broadcast_client_message = _gdk_haiku_screen_broadcast_client_message;
  screen_class->get_setting = _gdk_haiku_screen_get_setting;
  screen_class->get_rgba_visual = _gdk_haiku_screen_get_rgba_visual;
