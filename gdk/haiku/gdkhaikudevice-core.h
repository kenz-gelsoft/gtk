...
#define GDK_TYPE_QUARTZ_DEVICE_CORE         (gdk_haiku_device_core_get_type ())
#define GDK_HAIKU_DEVICE_CORE(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), GDK_TYPE_QUARTZ_DEVICE_CORE, GdkHaikuDeviceCore))
#define GDK_HAIKU_DEVICE_CORE_CLASS(c)     (G_TYPE_CHECK_CLASS_CAST ((c), GDK_TYPE_QUARTZ_DEVICE_CORE, GdkHaikuDeviceCoreClass))
...
#define GDK_HAIKU_DEVICE_CORE_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), GDK_TYPE_QUARTZ_DEVICE_CORE, GdkHaikuDeviceCoreClass))
