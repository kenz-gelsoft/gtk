...
create_standard_visual (GdkScreen *screen,
                        gint       depth)
{
  GdkVisual *visual = (GdkVisual *)g_object_new (GDK_TYPE_HAIKU_VISUAL, NULL);
...
static void
gdk_haiku_visual_class_init (GdkHaikuVisualClass *klass)
{
}
...
GdkVisual *
_gdk_haiku_screen_get_rgba_visual (GdkScreen *screen)
{
  return rgba_visual;
}
