...
void _gdk_haiku_window_init_windowing      (GdkDisplay *display,
                                             GdkScreen  *screen);
void _gdk_haiku_events_init                (void);
...
void         _gdk_haiku_events_update_focus_window    (GdkWindow *new_window,
                                                        gboolean   got_focus);
void         _gdk_haiku_events_send_map_event         (GdkWindow *window);

GdkModifierType _gdk_haiku_events_get_current_keyboard_modifiers (void);
GdkModifierType _gdk_haiku_events_get_current_mouse_modifiers    (void);
...
gboolean _gdk_haiku_display_has_pending  (GdkDisplay *display);

void       _gdk_haiku_display_event_data_copy (GdkDisplay     *display,
                                                const GdkEvent *src,
                                                GdkEvent       *dst);
void       _gdk_haiku_display_event_data_free (GdkDisplay     *display,
                                                GdkEvent       *event);
...
GdkKeymap * _gdk_haiku_display_get_keymap (GdkDisplay *display);
...
gint        _gdk_haiku_display_text_property_to_utf8_list (GdkDisplay     *display,
                                                            ...
                                                            gint            length,
                                                            gchar        ***list);
gchar *     _gdk_haiku_display_utf8_to_string_target      (GdkDisplay     *displayt,
                                                            const gchar    *str);

/* Screen */
GdkScreen  *_gdk_haiku_screen_new                      (void);
void        _gdk_haiku_screen_update_window_sizes      (GdkScreen *screen);

/* Screen methods - visual */
GdkVisual *   _gdk_haiku_screen_get_rgba_visual            (GdkScreen      *screen);
GdkVisual *   _gdk_haiku_screen_get_system_visual          (GdkScreen      *screen);
gint          _gdk_haiku_screen_visual_get_best_depth      (GdkScreen      *screen);
GdkVisualType _gdk_haiku_screen_visual_get_best_type       (GdkScreen      *screen);
GdkVisual *   _gdk_haiku_screen_get_system_visual          (GdkScreen      *screen);
GdkVisual*    _gdk_haiku_screen_visual_get_best            (GdkScreen      *screen);
GdkVisual*    _gdk_haiku_screen_visual_get_best_with_depth (GdkScreen      *screen,
                                                             gint            depth);
GdkVisual*    _gdk_haiku_screen_visual_get_best_with_type  (GdkScreen      *screen,
                                                             GdkVisualType   visual_type);
GdkVisual*    _gdk_haiku_screen_visual_get_best_with_both  (GdkScreen      *screen,
                                                             gint            depth,
                                                             GdkVisualType   visual_type);
void          _gdk_haiku_screen_query_depths               (GdkScreen      *screen,
                                                             gint          **depths,
                                                             gint           *count);
void          _gdk_haiku_screen_query_visual_types         (GdkScreen      *screen,
                                                             GdkVisualType **visual_types,
                                                             gint           *count);
void          _gdk_haiku_screen_init_visuals               (GdkScreen      *screen);
GList *       _gdk_haiku_screen_list_visuals               (GdkScreen      *screen);

/* Screen methods - events */
void        _gdk_haiku_screen_broadcast_client_message (GdkScreen   *screen,
                                                         GdkEvent    *event);
gboolean    _gdk_haiku_screen_get_setting              (GdkScreen   *screen,
                                                         const gchar *name,
                                                         GValue      *value);

gboolean    _gdk_haiku_window_is_ancestor          (GdkWindow *ancestor,
                                                     GdkWindow *window);
void       _gdk_haiku_window_gdk_xy_to_xy          (gint       gdk_x,
                                                     gint       gdk_y,
                                                     gint      *ns_x,
                                                     gint      *ns_y);
void       _gdk_haiku_window_xy_to_gdk_xy          (gint       ns_x,
                                                     gint       ns_y,
                                                     gint      *gdk_x,
                                                     gint      *gdk_y);
...
void       _gdk_haiku_window_attach_to_parent      (GdkWindow *window);
void       _gdk_haiku_window_detach_from_parent    (GdkWindow *window);
void       _gdk_haiku_window_did_become_main       (GdkWindow *window);
void       _gdk_haiku_window_did_resign_main       (GdkWindow *window);
void       _gdk_haiku_window_debug_highlight       (GdkWindow *window,
                                                     gint       number);

void       _gdk_haiku_window_update_position           (GdkWindow    *window);
void       _gdk_haiku_window_update_fullscreen_state   (GdkWindow    *window);

/* Window methods - testing */
void     _gdk_haiku_window_sync_rendering    (GdkWindow       *window);
gboolean _gdk_haiku_window_simulate_key      (GdkWindow       *window,
                                               gint             x,
                                               gint             y,
                                               guint            keyval,
                                               GdkModifierType  modifiers,
                                               GdkEventType     key_pressrelease);
gboolean _gdk_haiku_window_simulate_button   (GdkWindow       *window,
                                               gint             x,
                                               gint             y,
                                               guint            button,
                                               GdkModifierType  modifiers,
...
gboolean _gdk_haiku_window_get_property      (GdkWindow    *window,
                                               GdkAtom       property,
                                               GdkAtom       type,
                                               gulong        offset,
                                               gulong        length,
                                               ...
                                               gint         *actual_length,
                                               guchar      **data);
void     _gdk_haiku_window_change_property   (GdkWindow    *window,
                                               GdkAtom       property,
                                               GdkAtom       type,
                                               gint          format,
                                               GdkPropMode   mode,
                                               const guchar *data,
                                               gint          nelements);
void     _gdk_haiku_window_delete_property   (GdkWindow    *window,
                                               GdkAtom       property);

/* Display methods - frame clock */
void        _gdk_haiku_display_add_frame_callback    (GdkDisplay             *display,
                                                       GdkWindow              *window);
