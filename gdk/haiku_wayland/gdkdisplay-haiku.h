...
#include <haiku-egl.h>
#include <gdk/haiku/tablet-unstable-v2-client-protocol.h>
#include <gdk/haiku/gtk-shell-client-protocol.h>
#include <gdk/haiku/xdg-shell-client-protocol.h>
#include <gdk/haiku/xdg-shell-unstable-v6-client-protocol.h>
#include <gdk/haiku/xdg-foreign-unstable-v1-client-protocol.h>
#include <gdk/haiku/xdg-foreign-unstable-v2-client-protocol.h>
#include <gdk/haiku/keyboard-shortcuts-inhibit-unstable-v1-client-protocol.h>
#include <gdk/haiku/server-decoration-client-protocol.h>
#include <gdk/haiku/xdg-output-unstable-v1-client-protocol.h>
#include <gdk/haiku/primary-selection-unstable-v1-client-protocol.h>
#ifdef HAVE_XDG_ACTIVATION
#include <gdk/haiku/xdg-activation-v1-client-protocol.h>
#endif
#include <gdk/haiku/cursor-shape-v1-client-protocol.h>
...
#define GDK_HAIKU_MAX_THEME_SCALE 4
#define GDK_HAIKU_THEME_SCALES_COUNT GDK_HAIKU_MAX_THEME_SCALE

#define GDK_ZWP_POINTER_GESTURES_V1_VERSION 1

typedef struct _GdkHaikuSelection GdkHaikuSelection;

typedef enum _GdkHaikuShellVariant
{
  GDK_HAIKU_SHELL_VARIANT_XDG_SHELL,
  GDK_HAIKU_SHELL_VARIANT_ZXDG_SHELL_V6,
} GdkHaikuShellVariant;
...
struct _GdkHaikuDisplay
{
  ...
  GdkHaikuShellVariant shell_variant;
  ...
  struct wl_cursor_theme *scaled_cursor_themes[GDK_HAIKU_THEME_SCALES_COUNT];
