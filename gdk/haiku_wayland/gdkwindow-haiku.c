...
static void
gdk_haiku_window_class_init (GdkHaikuWindowClass *haiku_window_class)
{
}

static void
gdk_haiku_window_init (GdkHaikuWindow *haiku_window)
{
}

#define GDK_TYPE_WINDOW_IMPL_WAYLAND              (_gdk_window_impl_haiku_get_type ())
...
{
  GdkHaikuWindowExported callback;
  gpointer user_data;
...
static void gdk_haiku_window_maybe_configure (GdkWindow *window,
                                                int        width,
                                                int        height,
                                                int        scale);
...
static void gdk_haiku_window_sync_margin (GdkWindow *window);
static void gdk_haiku_window_sync_input_region (GdkWindow *window);
static void gdk_haiku_window_sync_opaque_region (GdkWindow *window);
...
static gboolean gdk_haiku_window_is_exported (GdkWindow *window);
static void gdk_haiku_window_unexport (GdkWindow *window);
static void gdk_haiku_window_announce_decoration_mode (GdkWindow *window);
...
G_DEFINE_TYPE (GdkWindowImplWayland, _gdk_window_impl_haiku, GDK_TYPE_WINDOW_IMPL)

static void
_gdk_window_impl_haiku_init (GdkWindowImplWayland *impl)
{
  impl->scale = 1;
...
static void
_gdk_haiku_screen_add_orphan_dialog (GdkWindow *window)
{
  GdkHaikuDisplay *display_haiku =
    GDK_HAIKU_DISPLAY (gdk_window_get_display (window));

  if (!g_list_find (display_haiku->orphan_dialogs, window))
    display_haiku->orphan_dialogs =
      g_list_prepend (display_haiku->orphan_dialogs, window);
}
...
static void
_gdk_haiku_window_save_size (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
...
static void
_gdk_haiku_window_clear_saved_size (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
 ...
 */
static void
gdk_haiku_window_update_size (GdkWindow *window,
                                int32_t    width,
                                int32_t    height,
                                int        scale)
{
...
GdkWindow *
_gdk_haiku_screen_create_root_window (GdkScreen *screen,
                                        int        width,
                                        int        height)
{
  GdkHaikuDisplay *display_haiku =
    GDK_HAIKU_DISPLAY (gdk_screen_get_display (screen));
  GdkWindow *window;
  GdkWindowImplWayland *impl;

  window = _gdk_display_create_window (GDK_DISPLAY (display_haiku));
...
G_GNUC_END_IGNORE_DEPRECATIONS
  ...
  /* see init_randr_support() in gdkscreen-haiku.c */
...
fill_presentation_time_from_frame_time (GdkFrameTimings *timings,
                                        guint32          frame_time)
{
  /* The timestamp in a haiku frame is a msec time value that in some
  ...
  if (impl->display_server.outputs)
    {
      ...
      int refresh_rate =
        _gdk_haiku_screen_get_output_refresh_rate (display_haiku->screen,
...
window_update_scale (GdkWindow *window)
{
  ...
  gdk_haiku_window_maybe_configure (window, window->width, window->height, scale);
}
...
static void gdk_haiku_window_create_surface (GdkWindow *window);
...
G_GNUC_END_IGNORE_DEPRECATIONS
  ...
  gdk_haiku_window_create_surface (window);
...
static void
gdk_haiku_window_attach_image (GdkWindow *window)
{
  ...
  g_assert (_gdk_haiku_is_shm_surface (impl->staging_cairo_surface));

  /* Attach this new buffer to the surface */
  wl_surface_attach (impl->display_server.wl_surface,
                     _gdk_haiku_shm_surface_get_wl_buffer (impl->staging_cairo_surface),
  ...
  display = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
...
static const cairo_user_data_key_t gdk_haiku_window_cairo_key;
                         ...
                         struct wl_buffer *wl_buffer)
{
  ...
  GdkWindowImplWayland *impl = cairo_surface_get_user_data (cairo_surface, &gdk_haiku_window_cairo_key);
...
static void
gdk_haiku_window_ensure_cairo_surface (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (impl->display_server.egl_window)
    {
      if (impl->staging_cairo_surface &&
          _gdk_haiku_is_shm_surface (impl->staging_cairo_surface))
        g_clear_pointer (&impl->staging_cairo_surface, cairo_surface_destroy);
    ...
    {
      GdkHaikuDisplay *display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (impl->wrapper));
      struct wl_buffer *buffer;

      impl->staging_cairo_surface = _gdk_haiku_display_create_shm_surface (display_haiku,
                                                                             impl->wrapper->width,
                                                                             impl->wrapper->height,
                                                                             impl->scale);
      cairo_surface_set_user_data (impl->staging_cairo_surface,
                                   &gdk_haiku_window_cairo_key,
                                   g_object_ref (impl),
                                   (cairo_destroy_func_t)
                                   g_object_unref);
      buffer = _gdk_haiku_shm_surface_get_wl_buffer (impl->staging_cairo_surface);
...
gdk_haiku_window_ref_cairo_surface (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  gdk_haiku_window_ensure_cairo_surface (window);
...
static cairo_surface_t *
gdk_haiku_window_create_similar_image_surface (GdkWindow *     window,
...
static gboolean
gdk_window_impl_haiku_begin_paint (GdkWindow *window)
{
  gdk_haiku_window_ensure_cairo_surface (window);
...
static void
gdk_window_impl_haiku_end_paint (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (impl->staging_cairo_surface &&
    ...
    {
      gdk_haiku_window_attach_image (window);
  ...
  gdk_haiku_window_sync_margin (window);
  gdk_haiku_window_sync_opaque_region (window);
  gdk_haiku_window_sync_input_region (window);
}

static gboolean
gdk_window_impl_haiku_beep (GdkWindow *window)
{
  gdk_haiku_display_system_bell (gdk_window_get_display (window),
                                   window);
...
gdk_window_impl_haiku_finalize (GObject *object)
{
  ...
  if (gdk_haiku_window_is_exported (impl->wrapper))
    gdk_haiku_window_unexport_handle (impl->wrapper);
  ...
  G_OBJECT_CLASS (_gdk_window_impl_haiku_parent_class)->finalize (object);
}

static void
gdk_haiku_window_configure (GdkWindow *window,
                              int        width,
                              int        height,
                              int        scale)
{
  ...
  gdk_haiku_window_update_size (window, width, height, scale);
  _gdk_window_update_size (window);

  display = gdk_window_get_display (window);
  _gdk_haiku_display_deliver_event (display, event);
}
...
static void
gdk_haiku_window_maybe_configure (GdkWindow *window,
                                    int        width,
                                    int        height,
                                    int        scale)
{
  ...
  gdk_haiku_window_configure (window, width, height, scale);
...
static void
gdk_haiku_window_sync_parent (GdkWindow *window,
                                GdkWindow *parent)
{
  GdkHaikuDisplay *display_haiku =
    GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  ...
  switch (display_haiku->shell_variant)
    {
    case GDK_HAIKU_SHELL_VARIANT_XDG_SHELL:
      {
      ...
      break;
    case GDK_HAIKU_SHELL_VARIANT_ZXDG_SHELL_V6:
      {
...
static void
gdk_haiku_window_sync_parent_of_imported (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
...
static void
gdk_haiku_window_update_dialogs (GdkWindow *window)
{
  GdkHaikuDisplay *display_haiku =
    GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GList *l;

  if (!display_haiku->orphan_dialogs)
    return;

  for (l = display_haiku->orphan_dialogs; l; l = l->next)
    {
      GdkWindow *w = l->data;
      GdkWindowImplWayland *impl;
	...
	continue;
      ...
      gdk_haiku_window_sync_parent (w, window);
    }
}

static void
gdk_haiku_window_sync_title (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display_haiku =
    GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
...
static void
gdk_haiku_window_get_window_geometry (GdkWindow    *window,
...
static void
gdk_haiku_window_sync_margin (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display_haiku =
    GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  ...
  gdk_haiku_window_get_window_geometry (window, &geometry);
...
wl_region_from_cairo_region (GdkHaikuDisplay *display,
                             cairo_region_t    *region)
{
...
static void
gdk_haiku_window_sync_opaque_region (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (impl->opaque_region != NULL)
    wl_region = wl_region_from_cairo_region (GDK_HAIKU_DISPLAY (gdk_window_get_display (window)),
                                             impl->opaque_region);
...
static void
gdk_haiku_window_sync_input_region (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  struct wl_region *wl_region = NULL;
...
static void
gdk_haiku_set_input_region_if_empty (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display;
               ...
               struct wl_output  *output)
{
  ...
  output_is_unmanaged =
    _gdk_haiku_screen_get_output_scale (display_haiku->screen, output) == 0;
                             ...
                             GdkWindow            *window)
{
  ...
  gdk_haiku_set_input_region_if_empty (window);
}

static void
gdk_haiku_window_set_subsurface_position (GdkWindow *window,
                                            int        x,
                                            int        y)
{
  GdkWindowImplWayland *impl;
...
static void
gdk_haiku_window_create_subsurface (GdkWindow *window)
{
  ...
  if (parent_impl && parent_impl->display_server.wl_surface)
    {
      display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
      impl->display_server.wl_subsurface =
        wl_subcompositor_get_subsurface (display_haiku->subcompositor,
      ...
      gdk_haiku_window_set_subsurface_position (window,
...
static void
gdk_haiku_window_create_surface (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));

  impl->display_server.wl_surface = wl_compositor_create_surface (display_haiku->compositor);
...
static void
gdk_haiku_window_handle_configure (GdkWindow *window,
                                     uint32_t   serial)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display_haiku =
  ...
  if (width > 0 && height > 0)
    {
      ...
      if (!saved_size)
        {
          ...
          _gdk_haiku_window_save_size (window);
        }
      ...
      gdk_haiku_window_configure (window,
                                    configure_width,
                                    configure_height,
                                    impl->scale);
    }
  ...
  if (impl->hint != GDK_WINDOW_TYPE_HINT_DIALOG &&
    ...
    gdk_haiku_window_update_dialogs (window);
...
static void
gdk_haiku_window_handle_configure_toplevel (GdkWindow     *window,
                                              int32_t        width,
                                              int32_t        height,
                                              GdkWindowState state,
                                              gboolean       suspended)
...
static void
gdk_haiku_window_handle_close (GdkWindow *window)
{
  GdkDisplay *display;
  GdkEvent *event;
                       ...
                       uint32_t            serial)
{
  ...
  gdk_haiku_window_handle_configure (window, serial);
}
                        ...
                        struct wl_array     *states)
{
  ...
  gdk_haiku_window_handle_configure_toplevel (window, width, height,
                    ...
                    struct xdg_toplevel *xdg_toplevel)
{
  ...
  gdk_haiku_window_handle_close (window);
}
...
create_xdg_toplevel_resources (GdkWindow *window)
{
  ...
  impl->display_server.xdg_surface =
    xdg_wm_base_get_xdg_surface (display_haiku->xdg_wm_base,
                                 impl->display_server.wl_surface);
...
create_zxdg_toplevel_v6_resources (GdkWindow *window)
{
  ...
  impl->display_server.zxdg_surface_v6 =
    zxdg_shell_v6_get_xdg_surface (display_haiku->zxdg_shell_v6,
                                   impl->display_server.wl_surface);
...
/**
 * gdk_haiku_window_set_application_id:
 * @window:
 * @application_id:
 *
 * Since: 3.24.22
 */
void
gdk_haiku_window_set_application_id (GdkWindow *window, const char* application_id)
{
  GdkWindowImplWayland *impl;
  GdkHaikuDisplay *display_haiku;
...
static void
gdk_haiku_window_create_xdg_toplevel (GdkWindow *window)
{
  GdkHaikuDisplay *display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  const gchar *app_id;
...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  if (impl->initial_fullscreen_monitor >= 0 &&
    ...
    fullscreen_output =
      _gdk_haiku_screen_get_wl_output (screen,
...
G_GNUC_END_IGNORE_DEPRECATIONS
  ...
  gdk_haiku_window_sync_parent (window, NULL);
  gdk_haiku_window_sync_parent_of_imported (window);
  gdk_haiku_window_sync_title (window);
  ...
  gdk_haiku_window_set_application_id (window, app_id);

  maybe_set_gtk_surface_dbus_properties (window);
  maybe_set_gtk_surface_modal (window);

  if (impl->hint == GDK_WINDOW_TYPE_HINT_DIALOG)
    _gdk_haiku_screen_add_orphan_dialog (window);

  wl_surface_commit (impl->display_server.wl_surface);
}

static void
gdk_haiku_window_handle_configure_popup (GdkWindow *window,
                                           int32_t    x,
                                           int32_t    y,
                                           int32_t    width,
                                           int32_t    height)
                     ...
                     int32_t           height)
{
  ...
  gdk_haiku_window_handle_configure_popup (window, x, y, width, height);
}
...
kwin_server_decoration_mode_set (void *data, struct org_kde_kwin_server_decoration *org_kde_kwin_server_decoration, uint32_t mode)
{
  ...
  if ((mode == ORG_KDE_KWIN_SERVER_DECORATION_MODE_SERVER && impl->using_csd) ||
    ...
    gdk_haiku_window_announce_decoration_mode (window);
}
...
static void
gdk_haiku_window_announce_decoration_mode (GdkWindow *window)
{
  GdkHaikuDisplay *display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (!impl->display_server.server_decoration)
    {
      impl->display_server.server_decoration =
        org_kde_kwin_server_decoration_manager_create (display_haiku->server_decoration_manager,
                                                                                         impl->display_server.wl_surface);
...
void
gdk_haiku_window_announce_csd (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
...
void
gdk_haiku_window_announce_ssd (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
                                ...
                                gboolean     *flipped_y)
{
  ...
  g_return_if_fail (GDK_IS_HAIKU_WINDOW (window));
                          ...
                          GdkWindow *parent)
{
  ...
  gdk_haiku_window_get_window_geometry (parent, &parent_geometry);
...
static void
gdk_haiku_window_create_xdg_popup (GdkWindow      *window,
                                     GdkWindow      *parent,
                                     struct wl_seat *seat)
{
  GdkHaikuDisplay *display = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (seat)
    {
      ...
      serial = _gdk_haiku_seat_get_last_implicit_grab_serial (gdk_seat, NULL);
...
find_grab_input_seat (GdkWindow *window, GdkWindow *transient_for)
{
  ...
  if (impl->grab_input_seat)
    return gdk_haiku_seat_get_wl_seat (impl->grab_input_seat);
  ...
  if (attached_grab_window)
    {
      ...
      if (tmp_impl->grab_input_seat)
        return gdk_haiku_seat_get_wl_seat (tmp_impl->grab_input_seat);
    }
...
static void
gdk_haiku_window_map (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (should_map_as_subsurface (window))
    {
      if (impl->transient_for)
        gdk_haiku_window_create_subsurface (window);
      else
  ...
  else if (should_map_as_popup (window))
    {
      ...
      if (!create_fallback)
        {
          gdk_haiku_window_create_xdg_popup (window,
                                               transient_for,
                                               grab_input_seat);
        }
      else
        {
          gdk_haiku_window_create_xdg_toplevel (window);
          gdk_haiku_window_announce_decoration_mode (window);
        }
    }
  else
...
static void
gdk_haiku_window_show (GdkWindow *window,
...
unmap_popups_for_window (GdkWindow *window)
{
  ...
  display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  for (l = display_haiku->current_popups; l; l = l->next)
    {
...
static void
gdk_haiku_window_hide_surface (GdkWindow *window)
{
  GdkHaikuDisplay *display_haiku = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  ...
  if (impl->display_server.wl_surface)
    {
      if (impl->dummy_egl_surface)
        {
          eglDestroySurface (display_haiku->egl_display, impl->dummy_egl_surface);
      ...
      if (impl->egl_surface)
        {
          eglDestroySurface (display_haiku->egl_display, impl->egl_surface);
      ...
      if (impl->display_server.xdg_toplevel)
      ...
      else if (impl->display_server.xdg_popup)
        {
          ...
          display_haiku->current_popups =
            g_list_remove (display_haiku->current_popups, window);
      ...
      if (impl->display_server.gtk_surface)
        {
          if (display_haiku->gtk_shell_version >=
      ...
      if (impl->hint == GDK_WINDOW_TYPE_HINT_DIALOG && !impl->transient_for)
        display_haiku->orphan_dialogs =
          g_list_remove (display_haiku->orphan_dialogs, window);
    }

  unset_transient_for_exported (window);

  _gdk_haiku_window_clear_saved_size (window);
  drop_cairo_surfaces (window);
  impl->pending_commit = FALSE;
  impl->mapped = FALSE;
}
...
static void
gdk_haiku_window_hide (GdkWindow *window)
{
  gdk_haiku_window_hide_surface (window);
  _gdk_window_clear_update_area (window);
}

static void
gdk_window_haiku_withdraw (GdkWindow *window)
{
  if (!window->destroyed)
    {
      if (GDK_WINDOW_IS_MAPPED (window))
...
static void
gdk_window_haiku_set_events (GdkWindow    *window,
                               GdkEventMask  event_mask)
{
...
static void
gdk_window_haiku_raise (GdkWindow *window)
{
}

static void
gdk_window_haiku_lower (GdkWindow *window)
{
}

static void
gdk_window_haiku_restack_under (GdkWindow *window,
                                  GList     *native_siblings)
{
}

static void
gdk_window_haiku_restack_toplevel (GdkWindow *window,
                                     GdkWindow *sibling,
                                     gboolean   above)
{
}
...
static void
gdk_window_haiku_move_resize (GdkWindow *window,
                                gboolean   with_move,
                                gint       x,
                                gint       y,
                                gint       width,
  ...
  if (width > 0 && height > 0)
    {
      if (!should_use_fixed_size (window->state) ||
        ...
        {
          gdk_haiku_window_maybe_configure (window,
                                              width,
                                              height,
                                              impl->scale);
        }
...
static void
gdk_window_haiku_move_to_rect (GdkWindow          *window,
...
static void
gdk_window_haiku_set_background (GdkWindow       *window,
                                   cairo_pattern_t *pattern)
{
}

static gboolean
gdk_window_haiku_reparent (GdkWindow *window,
...
static void
gdk_window_haiku_set_device_cursor (GdkWindow *window,
                                      GdkDevice *device,
                                      GdkCursor *cursor)
{
...
static void
gdk_window_haiku_get_geometry (GdkWindow *window,
                                 gint      *x,
                                 gint      *y,
                                 gint      *width,
                                 gint      *height)
...
static void
gdk_window_haiku_get_root_coords (GdkWindow *window,
                                    gint       x,
                                    gint       y,
                                    gint      *root_x,
                                    gint      *root_y)
...
static gboolean
gdk_window_haiku_get_device_state (GdkWindow       *window,
                                     GdkDevice       *device,
                                     gdouble         *x,
                                     gdouble         *y,
...
static void
gdk_window_haiku_shape_combine_region (GdkWindow            *window,
...
static void
gdk_window_haiku_input_shape_combine_region (GdkWindow            *window,
                                               const cairo_region_t *shape_region,
                                               gint                  offset_x,
                                               gint                  offset_y)
{
...
static void
gdk_window_haiku_destroy_foreign (GdkWindow *window)
{
}
                          ...
                          guint32    timestamp)
{
  ...
  startup_id = g_steal_pointer (&display_haiku->startup_notification_id);
      ...
      if (!startup_id)
        {
          ...
          event_queue = wl_display_create_queue (display_haiku->wl_display);

          token = xdg_activation_v1_get_activation_token (display_haiku->xdg_activation);
          ...
          while (startup_id == NULL)
            wl_display_dispatch_queue (display_haiku->wl_display, event_queue);

          xdg_activation_token_v1_destroy (token);
          wl_event_queue_destroy (event_queue);
        }

      xdg_activation_v1_activate (display_haiku->xdg_activation,
                                  startup_id,
                                  impl->display_server.wl_surface);
    }
  else
  ...
  if (impl->display_server.gtk_surface)
    {
      ...
      else if (startup_id && display_haiku->gtk_shell_version >= 3)
...
static void
gdk_haiku_window_init_gtk_surface (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display =
    GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
...
maybe_set_gtk_surface_modal (GdkWindow *window)
{
  ...
  gdk_haiku_window_init_gtk_surface (window);
  if (impl->display_server.gtk_surface == NULL)
    return;
                                   ...
                                   const gchar *startup_id)
{
  ...
  if (!startup_id)
    {
      free_me = g_steal_pointer (&display_haiku->startup_notification_id);
      startup_id = free_me;
    }

#ifdef HAVE_XDG_ACTIVATION
  if (display_haiku->xdg_activation && startup_id)
    {
      xdg_activation_v1_activate (display_haiku->xdg_activation,
                                  startup_id,
				  impl->display_server.wl_surface);
...
static void
gdk_haiku_window_fullscreen_on_monitor (GdkWindow *window, gint monitor)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkScreen *screen = gdk_window_get_screen (window);
  struct wl_output *fullscreen_output = 
    _gdk_haiku_screen_get_wl_output (screen, monitor);
...
static void
gdk_haiku_window_set_keep_above (GdkWindow *window, gboolean setting)
{
}

static void
gdk_haiku_window_set_keep_below (GdkWindow *window, gboolean setting)
{
}
                                      ...
                                      guint32        timestamp)
{
  ...
  serial = _gdk_haiku_seat_get_last_implicit_grab_serial (gdk_device_get_seat (device),
                                                            &sequence);
  ...
  switch (display_haiku->shell_variant)
    ...
    case GDK_HAIKU_SHELL_VARIANT_XDG_SHELL:
      xdg_toplevel_resize (impl->display_server.xdg_toplevel,
                           gdk_haiku_device_get_wl_seat (device),
                           serial, resize_edges);
      break;
    case GDK_HAIKU_SHELL_VARIANT_ZXDG_SHELL_V6:
  ...
  if (sequence)
    gdk_haiku_device_unset_touch_grab (device, sequence);
...
static void
gdk_haiku_window_set_composited (GdkWindow *window,
                                   gboolean   composited)
{
}
...
static void
gdk_haiku_window_sync_rendering (GdkWindow *window)
{
}

static gboolean
gdk_haiku_window_simulate_key (GdkWindow       *window,
                                 gint             x,
                                 gint             y,
                                 guint            keyval,
...
static gboolean
gdk_haiku_window_simulate_button (GdkWindow       *window,
                                    gint             x,
                                    gint             y,
                                    guint            button,
                                    GdkModifierType  modifiers,
...
static gboolean
gdk_haiku_window_get_property (GdkWindow   *window,
                                 GdkAtom      property,
                                 GdkAtom      type,
                                 gulong       offset,
                                 gulong       length,
...
static void
gdk_haiku_window_change_property (GdkWindow    *window,
                                    GdkAtom       property,
                                    GdkAtom       type,
                                    gint          format,
                                    GdkPropMode   mode,
                                    ...
                                    gint          nelements)
{
  if (property == gdk_atom_intern_static_string ("GDK_SELECTION"))
    gdk_haiku_selection_store (window, type, mode, data, nelements * (format / 8));
}

static void
gdk_haiku_window_delete_property (GdkWindow *window,
                                    GdkAtom    property)
{
}
...
static void
gdk_haiku_window_set_opaque_region (GdkWindow      *window,
                                      cairo_region_t *region)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
                                     ...
                                     int        bottom)
{
  ...
  new_height = (calculate_height_without_margin (window, window->height) +
                (top + bottom));
  gdk_haiku_window_maybe_configure (window, new_width, new_height, impl->scale);
...
static gboolean
gdk_haiku_window_show_window_menu (GdkWindow *window,
                                     GdkEvent  *event)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display_haiku =
  ...
  device = GDK_HAIKU_DEVICE (gdk_event_get_device (event));
  seat = gdk_haiku_device_get_wl_seat (GDK_DEVICE (device));
  ...
  serial = _gdk_haiku_device_get_implicit_grab_serial (device, event);
...
static gboolean
gdk_haiku_window_titlebar_gesture (GdkWindow          *window,
                                     GdkTitlebarGesture  gesture)
{
  ...
  wl_seat = gdk_haiku_seat_get_wl_seat (seat);

  serial = _gdk_haiku_seat_get_last_implicit_grab_serial (seat, NULL);
...
static void
_gdk_window_impl_haiku_class_init (GdkWindowImplWaylandClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GdkWindowImplClass *impl_class = GDK_WINDOW_IMPL_CLASS (klass);

  object_class->finalize = gdk_window_impl_haiku_finalize;

  impl_class->ref_cairo_surface = gdk_haiku_window_ref_cairo_surface;
  impl_class->create_similar_image_surface = gdk_haiku_window_create_similar_image_surface;
  impl_class->show = gdk_haiku_window_show;
  impl_class->hide = gdk_haiku_window_hide;
  impl_class->withdraw = gdk_window_haiku_withdraw;
  impl_class->set_events = gdk_window_haiku_set_events;
  impl_class->get_events = gdk_window_haiku_get_events;
  impl_class->raise = gdk_window_haiku_raise;
  impl_class->lower = gdk_window_haiku_lower;
  impl_class->restack_under = gdk_window_haiku_restack_under;
  impl_class->restack_toplevel = gdk_window_haiku_restack_toplevel;
  impl_class->move_resize = gdk_window_haiku_move_resize;
  impl_class->move_to_rect = gdk_window_haiku_move_to_rect;
  impl_class->set_background = gdk_window_haiku_set_background;
  impl_class->reparent = gdk_window_haiku_reparent;
  impl_class->set_device_cursor = gdk_window_haiku_set_device_cursor;
  impl_class->get_geometry = gdk_window_haiku_get_geometry;
  impl_class->get_root_coords = gdk_window_haiku_get_root_coords;
  impl_class->get_device_state = gdk_window_haiku_get_device_state;
  impl_class->shape_combine_region = gdk_window_haiku_shape_combine_region;
  impl_class->input_shape_combine_region = gdk_window_haiku_input_shape_combine_region;
  impl_class->destroy = gdk_haiku_window_destroy;
  impl_class->destroy_foreign = gdk_window_haiku_destroy_foreign;
  impl_class->get_shape = gdk_haiku_window_get_shape;
  impl_class->get_input_shape = gdk_haiku_window_get_input_shape;
  impl_class->begin_paint = gdk_window_impl_haiku_begin_paint;
  impl_class->end_paint = gdk_window_impl_haiku_end_paint;
  impl_class->beep = gdk_window_impl_haiku_beep;
  ...
  impl_class->fullscreen_on_monitor = gdk_haiku_window_fullscreen_on_monitor;
  ...
  impl_class->set_composited = gdk_haiku_window_set_composited;
  impl_class->destroy_notify = gdk_haiku_window_destroy_notify;
  impl_class->get_drag_protocol = _gdk_haiku_window_get_drag_protocol;
  impl_class->register_dnd = _gdk_haiku_window_register_dnd;
  impl_class->drag_begin = _gdk_haiku_window_drag_begin;
  impl_class->sync_rendering = gdk_haiku_window_sync_rendering;
  impl_class->simulate_key = gdk_haiku_window_simulate_key;
  impl_class->simulate_button = gdk_haiku_window_simulate_button;
  impl_class->get_property = gdk_haiku_window_get_property;
  impl_class->change_property = gdk_haiku_window_change_property;
  impl_class->delete_property = gdk_haiku_window_delete_property;
  impl_class->get_scale_factor = gdk_haiku_window_get_scale_factor;
  impl_class->set_opaque_region = gdk_haiku_window_set_opaque_region;
  impl_class->set_shadow_width = gdk_haiku_window_set_shadow_width;
  impl_class->show_window_menu = gdk_haiku_window_show_window_menu;
  ...
  impl_class->titlebar_gesture = gdk_haiku_window_titlebar_gesture;
...
void
_gdk_haiku_window_set_grab_seat (GdkWindow *window,
                                   GdkSeat   *seat)
{
  GdkWindowImplWayland *impl;
...
/**
 * gdk_haiku_window_get_wl_surface:
 * @window: (type GdkHaikuWindow): a #GdkWindow
 *
 ...
 */
struct wl_surface *
gdk_haiku_window_get_wl_surface (GdkWindow *window)
{
...
struct wl_output *
gdk_haiku_window_get_wl_output (GdkWindow *window)
{
  GdkWindowImplWayland *impl;
...
gdk_haiku_window_get_wl_egl_window (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
...
EGLSurface
gdk_haiku_window_get_egl_surface (GdkWindow *window,
                                    EGLConfig  config)
{
  GdkHaikuDisplay *display = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GdkWindowImplWayland *impl;
  ...
  if (impl->egl_surface == NULL)
    {
      egl_window = gdk_haiku_window_get_wl_egl_window (window);
...
EGLSurface
gdk_haiku_window_get_dummy_egl_surface (GdkWindow *window,
                                          EGLConfig  config)
{
  GdkHaikuDisplay *display = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  GdkWindowImplWayland *impl;
...
struct gtk_surface1 *
gdk_haiku_window_get_gtk_surface (GdkWindow *window)
{
  g_return_val_if_fail (GDK_IS_HAIKU_WINDOW (window), NULL);
...
/**
 * gdk_haiku_window_set_use_custom_surface:
 * @window: (type GdkHaikuWindow): a #GdkWindow
 *
 ...
 *     gdk_haiku_window_set_custom_surface (window);
 *
 *     surface = gdk_haiku_window_get_wl_surface (window);
 ...
 */
void
gdk_haiku_window_set_use_custom_surface (GdkWindow *window)
{
  GdkWindowImplWayland *impl;
...
void
gdk_haiku_window_set_dbus_properties_libgtk_only (GdkWindow  *window,
...
void
_gdk_haiku_window_offset_next_wl_buffer (GdkWindow *window,
                                           int        x,
                                           int        y)
{
  GdkWindowImplWayland *impl;
...
/**
 * GdkHaikuWindowExported:
 * @window: the #GdkWindow that is exported
 * @handle: the handle
 * @user_data: user data that was passed to gdk_haiku_window_export_handle()
 *
...
static gboolean
gdk_haiku_window_is_exported (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
...
/**
 * gdk_haiku_window_export_handle:
 ...
 * gdk_haiku_window_unexport_handle() should be called to clean up resources.
 *
 ...
 * gdk_haiku_window_unexport_handle() must be called the same number of times
 * as gdk_haiku_window_export_handle() was called. Any 'exported' callback
 ...
 * gdk_haiku_window_set_transient_for_exported().
 *
 ...
 */
gboolean
gdk_haiku_window_export_handle (GdkWindow                *window,
                                  GdkHaikuWindowExported  callback,
                                  gpointer                  user_data,
                                  GDestroyNotify            destroy_func)
{
      ...
      if (!impl->display_server.xdg_exported_v2)
        {
          ...
          xdg_exported_v2 =
            zxdg_exporter_v2_export_toplevel (display_haiku->xdg_exporter_v2,
                                              impl->display_server.wl_surface);
  ...
  else if (display_haiku->xdg_exporter_v1)
    {
      if (!impl->display_server.xdg_exported_v1)
        {
          ...
          xdg_exported_v1 =
            zxdg_exporter_v1_export (display_haiku->xdg_exporter_v1,
                                     impl->display_server.wl_surface);
...
static void
gdk_haiku_window_unexport (GdkWindow *window)
{
  GdkWindowImplWayland *impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GList *l;
...
/**
 * gdk_haiku_window_unexport_handle:
 ...
 */
void
gdk_haiku_window_unexport_handle (GdkWindow *window)
{
  GdkWindowImplWayland *impl;
  ...
  if (impl->exported.export_count == 0)
    gdk_haiku_window_unexport (window);
}
 ...
 * from a gdk_haiku_window_export_handle() call in another process.
 *
 * Note that this API depends on an unstable Wayland protocol,
 * and thus may require changes in the future.
 *
 ...
 */
gboolean
gdk_haiku_window_set_transient_for_exported (GdkWindow *window,
                                               char      *parent_handle_str)
{
  ...
  if (display_haiku->xdg_importer_v2)
    {
      gdk_window_set_transient_for (window, NULL);

      impl->imported_v2_transient_for =
        zxdg_importer_v2_import_toplevel (display_haiku->xdg_importer_v2,
                                          parent_handle_str);
      zxdg_imported_v2_add_listener (impl->imported_v2_transient_for,
                                     &xdg_imported_v2_listener,
                                     window);
    }
  else if (display_haiku->xdg_importer_v1)
    {
      gdk_window_set_transient_for (window, NULL);

      impl->imported_v1_transient_for =
        zxdg_importer_v1_import (display_haiku->xdg_importer_v1,
                                 parent_handle_str);
...
gdk_haiku_window_get_inhibitor (GdkWindowImplWayland *impl,
                                  struct wl_seat *seat)
{
...
void
gdk_haiku_window_inhibit_shortcuts (GdkWindow *window,
                                      GdkSeat   *gdk_seat)
{
  GdkWindowImplWayland *impl= GDK_WINDOW_IMPL_WAYLAND (window->impl);
  GdkHaikuDisplay *display = GDK_HAIKU_DISPLAY (gdk_window_get_display (window));
  struct wl_surface *surface = impl->display_server.wl_surface;
  struct wl_seat *seat = gdk_haiku_seat_get_wl_seat (gdk_seat);
  struct zwp_keyboard_shortcuts_inhibitor_v1 *inhibitor;

  if (display->keyboard_shortcuts_inhibit == NULL)
    return;

  if (gdk_haiku_window_get_inhibitor (impl, seat))
...
void
gdk_haiku_window_restore_shortcuts (GdkWindow *window,
                                      GdkSeat   *gdk_seat)
{
  GdkWindowImplWayland *impl;
  struct wl_seat *seat;
  ...
  impl = GDK_WINDOW_IMPL_WAYLAND (window->impl);
  seat = gdk_haiku_seat_get_wl_seat (gdk_seat);

  inhibitor = gdk_haiku_window_get_inhibitor (impl, seat);
  if (inhibitor == NULL)
...
/**
 * gdk_haiku_window_add_frame_callback_surface:
 ...
 * gdk_haiku_window_remove_frame_callback_surface().
 *
 ...
 */
void
gdk_haiku_window_add_frame_callback_surface (GdkWindow         *window,
                                               struct wl_surface *surface)
{
  GdkWindowImplWayland *impl;
 ...
 */
void
gdk_haiku_window_remove_frame_callback_surface (GdkWindow         *window,
                                                  struct wl_surface *surface)
{
  GdkWindowImplWayland *impl;
