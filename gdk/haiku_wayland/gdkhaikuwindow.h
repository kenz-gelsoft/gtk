...
#else
typedef GdkWindow GdkHaikuWindow;
#endif
...
GDK_AVAILABLE_IN_ALL
struct wl_surface       *gdk_haiku_window_get_wl_surface       (GdkWindow *window);

GDK_AVAILABLE_IN_ALL
void                     gdk_haiku_window_set_use_custom_surface (GdkWindow *window);

GDK_AVAILABLE_IN_3_10
void                     gdk_haiku_window_set_dbus_properties_libgtk_only (GdkWindow  *window,
...
typedef void (*GdkHaikuWindowExported) (GdkWindow  *window,
                                          const char *handle,
                                          gpointer    user_data);

GDK_AVAILABLE_IN_3_22
gboolean                 gdk_haiku_window_export_handle (GdkWindow               *window,
                                                           GdkHaikuWindowExported callback,
                                                           gpointer                 user_data,
                                                           GDestroyNotify           destroy_func);

GDK_AVAILABLE_IN_3_22
void                     gdk_haiku_window_unexport_handle (GdkWindow *window);

GDK_AVAILABLE_IN_3_22
gboolean                 gdk_haiku_window_set_transient_for_exported (GdkWindow *window,
                                                                        char      *parent_handle_str);

GDK_AVAILABLE_IN_3_24
void                     gdk_haiku_window_set_application_id (GdkWindow *window,
                                                                const char *application_id);

GDK_AVAILABLE_IN_3_22
void gdk_haiku_window_announce_csd                        (GdkWindow *window);

GDK_AVAILABLE_IN_3_24
void gdk_haiku_window_announce_ssd                        (GdkWindow *window);

GDK_AVAILABLE_IN_3_24
void gdk_haiku_window_add_frame_callback_surface (GdkWindow         *window,
                                                    struct wl_surface *surface);

GDK_AVAILABLE_IN_3_24
void gdk_haiku_window_remove_frame_callback_surface (GdkWindow         *window,
                                                       struct wl_surface *surface);
