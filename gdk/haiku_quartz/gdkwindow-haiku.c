...
gdk_window_get_haiku_impl (GdkWindow* window)
{
  GdkWindow *embedder;
...
{
  GdkWindowImplQuartz *impl = gdk_window_get_haiku_impl (window);
...
static CGContextRef
gdk_window_impl_haiku_get_context (GdkWindowImplQuartz *window_impl,
				    gboolean             antialias)
{
...
static void
gdk_window_impl_haiku_release_context (GdkWindowImplQuartz *window_impl,
...
gdk_haiku_create_cairo_surface (GdkWindowImplQuartz *impl,
				 int                  width,
				 int                  height)
{
...
static void
gdk_window_impl_haiku_init (GdkWindowImplQuartz *impl)
{
                                               ...
                                               cairo_region_t    *region)
{
  ...
  impl = gdk_window_get_haiku_impl (window);
  ...
  if (in_process_all_updates)
    {
      ...
      GdkWindowImplQuartz *toplevel_impl =
            gdk_window_get_haiku_impl (toplevel);
  ...
  for (l = impl->sorted_children; l; l = l->next)
    {
      ...
      GdkWindowImplQuartz *child_impl = gdk_window_get_haiku_impl (child);
      int temp_x, temp_y;
...
{
  /* In haiku the transient-for behavior is implemented by
  ...
  GdkWindowImplQuartz *parent_impl =
        gdk_window_get_haiku_impl (impl->transient_for);
  if (parent_impl)
    {
...
_gdk_haiku_window_did_resign_main (GdkWindow *window)
{
  ...
  if (new_window &&
    ...
    {
      GdkWindowImplQuartz *impl = gdk_window_get_haiku_impl (new_window);
                                        ...
                                        gint           attributes_mask)
{
  ...
  parent_impl = gdk_window_get_haiku_impl (window->parent);
  ...
  switch (window->window_type)
      ...
      if (GDK_WINDOW_TYPE (window->parent) != GDK_WINDOW_ROOT)
	{
	  /* The common code warns for this case */
          parent_impl = gdk_window_get_haiku_impl (_gdk_root);
	}
    }
  ...
  switch (window->window_type)
    ...
    case GDK_WINDOW_CHILD:
      {
	GdkWindowImplQuartz *parent_impl = gdk_window_get_haiku_impl (window->parent);
                                   ...
                                   GdkScreen  *screen)
{
  ...
  impl = gdk_window_get_haiku_impl (_gdk_root);
  /* If impl is somehow not a GdkWindowImplQuartz we're screwed, so crash. */
  if (!impl)
    {
      g_error ("Initializing haiku windowing produced the wrong kind of impl!");
      g_abort ();
    }
                           ...
                           gboolean   foreign_destroy)
{
  ...
  if (parent)
    {
      GdkWindowImplQuartz *parent_impl = gdk_window_get_haiku_impl (parent);
  ...
  if (impl->transient_for && !GDK_WINDOW_DESTROYED (impl->transient_for))
    {
      ...
      parent_impl = gdk_window_get_haiku_impl (impl->transient_for);
      if (parent_impl)
        {
          [parent_impl->toplevel removeChildWindow:impl->toplevel];
          clear_toplevel_order ();
...
static inline void
window_haiku_move (GdkWindow *window,
                    gint       x,
                    gint       y)
{
  g_return_if_fail (GDK_IS_WINDOW (window));
...
static inline void
window_haiku_resize (GdkWindow *window,
                      gint       width,
                      gint       height)
{
  g_return_if_fail (GDK_IS_WINDOW (window));
...
static inline void
window_haiku_move_resize (GdkWindow *window,
                           gint       x,
                           gint       y,
                           gint       width,
                           gint       height)
                               ...
                               gint       height)
{
  if (with_move && (width < 0 && height < 0))
    window_haiku_move (window, x, y);
  else
    {
      if (with_move)
        window_haiku_move_resize (window, x, y, width, height);
      else
        window_haiku_resize (window, width, height);
    }
}
                            ...
                            gint       y)
{
  ...
  new_parent_impl = gdk_window_get_haiku_impl (new_parent);
  if (!new_parent_impl)
    return FALSE;
  ...
  old_parent_impl = gdk_window_get_haiku_impl (old_parent);
  if (!old_parent_impl)
    return FALSE;
...
update_toplevel_order (void)
{
  ...
  root_impl = gdk_window_get_haiku_impl (_gdk_root);
      ...
      if (parent)
        {
          ...
          impl = gdk_window_get_haiku_impl (parent);
          if (impl)
            {
				    ...
				    gboolean   above)
{
  ...
  impl = gdk_window_get_haiku_impl (sibling);
  if (impl)
                                   ...
                                   gint      *root_y)
{
  ...
  toplevel = gdk_window_get_toplevel (window);
  impl = gdk_window_get_haiku_impl (toplevel);
...
static GdkWindow *
gdk_window_haiku_get_device_state_helper (GdkWindow       *window,
                                           GdkDevice       *device,
                                           gdouble         *x,
                                           gdouble         *y,
...
gdk_window_haiku_get_device_state (GdkWindow       *window,
                                    ...
                                    GdkModifierType *mask)
{
  return gdk_window_haiku_get_device_state_helper (window,
                                                    device,
                                                    x, y, mask) != NULL;
}
                                     ...
                                     GdkWindow *parent)
{
  ...
  window_impl = gdk_window_get_haiku_impl (window);
  ...
  parent_impl = gdk_window_get_haiku_impl (parent);
...
static void
_gdk_haiku_window_update_has_shadow (GdkWindowImplQuartz *impl)
{
    gboolean has_shadow;
...
gdk_haiku_window_get_type_hint (GdkWindow *window)
{
  ...
  return gdk_window_get_haiku_impl (window)->type_hint;
}
...
static void
gdk_window_impl_haiku_class_init (GdkWindowImplQuartzClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GdkWindowImplClass *impl_class = GDK_WINDOW_IMPL_CLASS (klass);
  GdkWindowImplQuartzClass *impl_haiku_class = GDK_WINDOW_IMPL_QUARTZ_CLASS (klass);
  ...
  impl_haiku_class->get_context = gdk_window_impl_haiku_get_context;
  impl_haiku_class->release_context = gdk_window_impl_haiku_release_context;
}

GType
_gdk_window_impl_haiku_get_type (void)
{
  ...
  if (!object_type)
      ...
      const GTypeInfo object_info =
	{
	  ...
	  (GClassInitFunc) gdk_window_impl_haiku_class_init,
	  NULL,           /* class_finalize */
	  NULL,           /* class_data */
	  sizeof (GdkWindowImplQuartz),
	  0,              /* n_preallocs */
	  (GInstanceInitFunc) gdk_window_impl_haiku_init,
	};
...
CGContextRef
gdk_haiku_window_get_context (GdkWindowImplQuartz  *window,
                               gboolean             antialias)
{
...
void
gdk_haiku_window_release_context (GdkWindowImplQuartz  *window,
                                   CGContextRef          cg_context)
{
...
static CGContextRef gdk_root_window_impl_haiku_get_context (GdkWindowImplQuartz *window, gboolean antialias);
static void gdk_root_window_impl_haiku_release_context (GdkWindowImplQuartz *window, CGContextRef cg_context);

static void
gdk_root_window_impl_haiku_class_init (GdkRootWindowImplQuartzClass *klass)
{
  GdkWindowImplQuartzClass *window_haiku_class = GDK_WINDOW_IMPL_QUARTZ_CLASS (klass);
...
static void
gdk_root_window_impl_haiku_init (GdkRootWindowImplQuartz *impl)
{
...
static void
gdk_root_window_impl_haiku_dispose (GdkRootWindowImplQuartz *impl)
{
...
static CGContextRef
gdk_root_window_impl_haiku_get_context (GdkWindowImplQuartz *window_impl,
                                         gboolean             antialias)
{
...
static void
gdk_root_window_impl_haiku_release_context (GdkWindowImplQuartz *window,
                                             CGContextRef         cg_context)
{
