...
static guint32
gdk_haiku_server_send_message_with_size (GdkHaikuServer *server, BroadwayRequestBase *base,
...
#define gdk_haiku_server_send_message(_server, _msg, _type) \
  gdk_haiku_server_send_message_with_size(_server, (BroadwayRequestBase *)&_msg, sizeof (_msg), _type)
...
_gdk_haiku_server_flush (GdkHaikuServer *server)
{
  ...
  gdk_haiku_server_send_message(server, msg, BROADWAY_REQUEST_FLUSH);
}
