...
{
  G_OBJECT_CLASS (gdk_haiku_cursor_parent_class)->finalize (object);
}

static void
gdk_haiku_cursor_class_init (GdkHaikuCursorClass *xcursor_class)
{
...
/* Called by gdk_display_haiku_finalize to flush any cached cursors
 * for a dead display.
 */
void
_gdk_haiku_cursor_display_finalize (GdkDisplay *display)
{
}
...
void
_gdk_haiku_cursor_update_theme (GdkCursor *cursor)
{
